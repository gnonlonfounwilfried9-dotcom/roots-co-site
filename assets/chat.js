...
+ '<path d="M12 2.5v3"/><circle cx="12" cy="2" r="1" fill="currentColor" stroke="none"/>'
+ '<rect x="4" y="6.5" width="16" height="12.5" rx="4.5"/>'
+ '<path d="M9 12.2v-.8M15 12.2v-.8"/><path d="M9.5 15.3c.8.6 1.7.9 2.5.9s1.7-.3 2.5-.9"/>'
+ '<path d="M2 13h2M20 13h2"/></svg></button>'
