...
insert into public.products (ref, nom_fr, categorie_id, spec_fr, desc_fr, prix_ttc_fcfa, prix_ht_fcfa, stock, images) values
  ('RTS_2026360025','Dell 16','portables','16 pouces, Core i5-120U 10 coeurs, 16 Go, 512 Go SSD, Windows 11 Pro, garantie 1 an','Le portable qui remplace celui qui rame. Le Dell 16 arrive neuf et scellé, seize pouces, seize gigaoctets de mémoire, processeur Core i5 dix coeurs et Windows 11 Pro déjà installé. De quoi ouvrir dix onglets, un tableau et une visioconférence sans ralentir, un seul paiement, pas un abonnement caché. Garantie constructeur un an, livraison au Togo et au Bénin.',882937,748252,10,'["assets/produits/DC16250.png"]'::jsonb),
  ('RTS_2026360026','Dell Pro 14','portables','14 pouces, Core i5-120U 10 coeurs, 8 Go, 512 Go SSD, Ubuntu, garantie 3 ans','Trois ans de garantie, un seul prix affiché. Le Dell Pro 14 tourne sous Ubuntu, quatorze pouces, processeur Core i5 dix coeurs et 512 gigaoctets de stockage. Pensé pour un usage professionnel stable, sans les logiciels superflus qui ralentissent une machine neuve. La garantie de trois ans, la plus longue de notre catalogue portable, en dit long sur sa robustesse. Matériel neuf et scellé.',853722,723493,10,'["assets/produits/DP14-120U.png"]'::jsonb),
  ('RTS_2026360027','Dell Pro 14 Essential','portables','14 pouces, Core i3-100U 6 coeurs, 8 Go, 512 Go SSD, Ubuntu, garantie 2 ans','Le poste d''entrée qui ne fait pas semblant. Pour une première équipe ou un budget serré, le Dell Pro 14 Essential en configuration Core i3 fait le travail sans détour. Huit gigaoctets de mémoire, 512 gigaoctets de stockage, Ubuntu installé, garantie deux ans. Neuf et scellé, pas un reconditionné maquillé en neuf.',648239,549355,10,'["assets/produits/DP14E-i3U.png"]'::jsonb),
  ('RTS_2026360028','Dell Pro 14 Essential','portables','14 pouces, Core i3-100U 6 coeurs, 8 Go, 512 Go SSD, Windows 11 Pro, garantie 2 ans','Le premier ordinateur d''une activité qui démarre. On démarre une activité, le budget est serré, et la tentation de la machine la moins chère du marché est grande. Six mois plus tard, elle est à la poubelle. Le Dell Pro 14 Essential existe pour éviter ça, Windows 11 Pro installé, garantie deux ans. Neuf et scellé.',736859,624457,10,'["assets/produits/DP14E-i3W.png"]'::jsonb),
  ('RTS_2026360029','Dell Pro 14 Essential','portables','14 pouces, Core i5-220U 10 coeurs, 16 Go, 512 Go SSD, Ubuntu, garantie 1 an','Le double de mémoire, pour le même format. Même carrosserie que l''Essential i3, mais un processeur Core i5 dix coeurs et seize gigaoctets de mémoire qui changent tout dès que plusieurs logiciels tournent ensemble. Ubuntu installé, 512 gigaoctets de stockage, garantie un an.',834245,706987,10,'["assets/produits/DP14E-i5U.png"]'::jsonb),
